    ...
    public partial class CajaVentasPorCobrar : UserControl
    {
        ...
        public int VentaID
        {
            get
            {
                ...
                return Util.Entero(this.dgvDatos.CurrentRow.Cells["colVentaID"].Value);
            }
        }
        ...
        public int ClienteID
        {
            ...
            {
                if (this.dgvDatos.CurrentRow == null) return 0;
                return Util.Entero(this.dgvDatos.CurrentRow.Cells["colClienteID"].Value);
            }
        }
        ...
        public decimal ImporteVenta
        {
            ...
            {
                if (this.dgvDatos.CurrentRow == null) return 0;
                return Util.Decimal(this.dgvDatos.CurrentRow.Cells["colImporte"].Value);
            }
        }
        ...
        private void dgvDatos_RowStateChanged(object sender, DataGridViewRowStateChangedEventArgs e)
        {
            ...
            int iVentaID = Util.Entero(e.Row.Cells["colVentaID"].Value);
