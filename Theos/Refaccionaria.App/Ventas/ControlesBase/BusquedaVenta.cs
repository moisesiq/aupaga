...
namespace Refaccionaria.App
{
    public partial class BusquedaVenta : UserControl
    {
        ...
        private void dgvVentas_CurrentCellChanged(object sender, EventArgs e)
        {
            ...
            this.VentaID = (this.dgvVentas.CurrentRow == null ? 0 : Util.Entero(this.dgvVentas.CurrentRow.Cells["colVentaID"].Value));
        ...
        protected virtual void AplicarFiltro()
        {
            ...
            {
                Lista = Datos.GetListOf<VentasView>(q => (q.Folio == sFolio || q.FolioIni == sFolio) && (iSucursalID == 0 || q.SucursalID == iSucursalID));
            }
        ...
        protected virtual void MostrarDatosDeVenta(int iVentaID)
        {
            ...
            var oVentaPagos = Datos.GetListOf<VentasPagosDetalleAvanzadoView>(q => q.VentaID == iVentaID);
            if (oVentaV == null)
                return;
