...
namespace Refaccionaria.App
{
    public partial class BusquedaReimpresion : BusquedaVenta
    {
        ...
        protected override void MostrarDatosDeVenta(int iVentaID)
        {
            ...
            var oDetalle = Datos.GetListOf<VentasDetalleView>(q => q.VentaID == iVentaID);
            ...
            var oDevoluciones = Datos.GetListOf<VentasDevolucionesView>(c => c.VentaID == iVentaID);
            ...
            var oGarantias = Datos.GetListOf<VentasGarantiasView>(c => c.VentaID == iVentaID);
            ...
            var oNcFiscales = Datos.GetListOf<NotaDeCreditoFiscalDetalle>(c => c.VentaID == iVentaID);
            foreach (var oReg in oNcFiscales)
            {
                var oNcfV = Datos.GetEntity<NotasDeCreditoFiscalesView>(c => c.NotaDeCreditoFiscalID == oReg.NotaDeCreditoFiscalID);
                this.txtObservaciones.Text += (
