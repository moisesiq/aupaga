...
namespace Refaccionaria.App
{
    public partial class CatNominaOficialCuentas : ListadoEditable
    {
        ...
        private void dgvDatos_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                var oListado = Util.ListaEntityADataTable(Datos.GetListOf<ContaCuentaDeMayor>());
        ...
        protected override void CargarDatos()
        {
            ...
            var oDatos = Datos.GetListOf<NominaOficialCuentasView>();
        ...
        private bool Validar()
        {
            ...
            foreach (DataGridViewRow oFila in this.dgvDatos.Rows)
            {
                ...
                if (Util.Entero(oFila.Cells["ContaCuentaDeMayorID"].Value) == 0)
                {
