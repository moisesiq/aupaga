...
namespace Refaccionaria.App
{
    public partial class DetalleMostrarFirmas : Form
    {
        ...
        {
            var personales = Datos.GetListOf<ClientePersonal>(c => c.ClienteID == iClienteID && c.Estatus);
        ...
        {
            int iClientePersonalID = Util.Entero(this.dgvPersonal.CurrentRow.Cells["ClientePersonalID"].Value);
            try
            {
