    ...
    public partial class DetalleBusquedaDeMovimientos : Form
    {
        ...
        private void dgvPartes_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (this.dgvPartes.CurrentRow == null)
                return;
            var iParteID = Util.Entero(this.dgvPartes.CurrentRow.Cells["parParteID"].Value);
        ...
        private void LlenarPartes(int iProveedorID)
        {
            ...
            var oDatos = Datos.ExecuteProcedure<pauPartesMovimientosDevoluciones_Result>("pauPartesMovimientosDevoluciones", oParams);
        ...
        private void LlenarFacturas(int iParteID)
        {
            ...
            var oDatos = Datos.GetListOf<MovimientosInventarioDetalleAvanzadoView>(c => c.TipoOperacionID == Cat.TiposDeOperacionMovimientos.EntradaCompra 
