...
namespace Refaccionaria.App
{
    public partial class Eventos : Form
    {
        ...
        public void LlenarEventos(bool bHoy)
        {
            ...
            if (bHoy)
                oAlertas = Datos.GetListOf<ClientesEventosCalendarioView>(c => c.Fecha >= dHoy && c.Fecha < dManiana && !c.Revisado);
            else
                oAlertas = Datos.GetListOf<ClientesEventosCalendarioView>(c => c.Fecha >= dManiana && c.Fecha < dPasadoManiana && !c.Revisado);
