...
namespace Refaccionaria.App
{
    public partial class PolizaContable : Form
    {
        ...
        private void PolizaContable_Load(object sender, EventArgs e)
        {
            ...
            this.cmbTipoPoliza.CargarDatos("ContaTipoPolizaID", "TipoDePoliza", Datos.GetListOf<ContaTipoPoliza>());
            this.SucursalID.CargarDatos("SucursalID", "NombreSucursal", Datos.GetListOf<Sucursal>(c => c.Estatus));
        ...
        private void dgvDetalle_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.F4:
                    ...
                    break;
                case Keys.F3:
                    var oDatos = Util.ListaEntityADataTable(Datos.GetListOf<ContaCuentaAuxiliar>());
        ...
        private void dgvDetalle_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            bool bMayorQueCero = (Util.Decimal(this.dgvDetalle[e.ColumnIndex, e.RowIndex].Value) > 0);
        ...
        private void AfectarCargoAbonoFaltante()
        {
            ...
            {
                mCargo += Util.Decimal(oFila.Cells["Cargo"].Value);
                mAbono += Util.Decimal(oFila.Cells["Abono"].Value);
            }
        ...
        private bool Validar()
        {
            ...
            if (Util.Entero(this.cmbTipoPoliza.SelectedValue) <= 0)
            ...
            foreach (DataGridViewRow oFila in this.dgvDetalle.Rows)
            {
                ...
                //
                oFila.ErrorText = "";
                if (Util.Entero(oFila.Cells["SucursalID"].Value) == 0)
                {
        ...
        public void CargarPoliza(int iPolizaID)
        {
            ...
            var oPolizaDetV = Datos.GetListOf<ContaPolizasDetalleAvanzadoView>(c => c.ContaPolizaID == iPolizaID);
