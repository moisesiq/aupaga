...
namespace Refaccionaria.App
{
    public partial class DepositoEfectivoResg : Form
    {
        ...
        private void DepositoEfectivoResg_Load(object sender, EventArgs e)
        {
            ...
            var oResguardos = Datos.GetListOf<ContaPolizasDetalleAvanzadoView>(c => c.ContaCuentaAuxiliarID == Cat.ContaCuentasAuxiliares.Resguardo
        ...
        private void CalcularImporteDia()
        {
            ...
            var oFacturasEfe = Datos.GetListOf<VentasPagosDetalleAvanzadoView>(c => c.SucursalID == GlobalClass.SucursalID && c.Facturada
            ...
            var oTicketsNoEfe = Datos.GetListOf<VentasPagosDetalleAvanzadoView>(c => c.SucursalID == GlobalClass.SucursalID && !c.Facturada
            ...
            var oFacturaGlobal = Datos.GetEntity<CajaFacturaGlobal>(c => c.Dia == dDia);
            var oDevEfe = Datos.GetListOf<VentasDevolucionesView>(c => c.SucursalID == GlobalClass.SucursalID && c.FormaDePagoID == Cat.FormasDePago.Efectivo
                && EntityFunctions.TruncateTime(c.Fecha) == dDia);
