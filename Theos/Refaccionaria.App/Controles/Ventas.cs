...
namespace Refaccionaria.App
{
    public partial class Ventas : UserControl
    {
        ...
        public ClientesDatosView Cliente
        {
            ...
            set
            {
                ...
                */
                ...
                if (this.Cliente != null && Util.Entero(this.tacCliente.ValorSel) != this.Cliente.ClienteID)
        ...
        public decimal Total { get { return Util.Decimal(this.lblTotal.Text.SoloNumeric()); } }

        public bool CobroAlFrente { get { return (Util.ControlAlFrente(this.pnlContenidoDetalle) == this.ctlCobro); } }
        ...
        {
            // Para la comisión
            this.mPorComision = (Util.Decimal(Config.Valor("Comisiones.Vendedor.Porcentaje")) / 100);

            // Se cargan los datos de los clientes
            this.cmbCliente.CargarDatos("ClienteID", "Nombre", Datos.GetListOf<ClientesDatosView>(q => q.ListaDePrecios > 0).OrderBy(q => q.Nombre).ToList());
            this.tacCliente.CargarDatos("ClienteID", "Nombre", Datos.GetListOf<Cliente>().OrderBy(o => o.Nombre).ToList());
            ...
            this.tacVechiculo.CargarDatos("ModeloID", "NombreModelo", Datos.GetListOf<ModelosView>().OrderBy(c => c.NombreModelo).ToList());
            this.tacVechiculo.MostrarVariasColumnas("NombreModelo", "NombreMarca");
            this.cmbMarca.CargarDatos("MarcaID", "NombreMarca", Datos.GetListOf<Marca>(q => q.Estatus).OrderBy(o => o.NombreMarca).ToList());
            ...
            this.cmbSistema.CargarDatos("SistemaID", "NombreSistema", Datos.GetListOf<Sistema>(q => q.Estatus).OrderBy(o => o.NombreSistema).ToList());
            this.cmbMarcaParte.CargarDatos("MarcaParteID", "NombreMarcaParte", Datos.GetListOf<MarcaParte>(q => q.Estatus)
            ...
            var oMetasSuc = Datos.GetEntity<MetaSucursal>(c => c.SucursalID == GlobalClass.SucursalID);
            ...
            VentasLoc.ActualizarBarraDeMetas(null);
        }
        ...
        private void cmbCliente_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            { // dpend Quitar el try después de lo del cambio del servidor
                var oClienteCredito = Datos.GetEntity<ClientesCreditoView>(q => q.ClienteID == this.Cliente.ClienteID);
        ...
        private void tacCliente_SeleccionCambiada(object sender, EventArgs e)
        {
            ...
            this.cmbCliente.SelectedValue = Util.Entero(this.tacCliente.ValorSel);
        }
        ...
        private void cmbVehiculo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            var VehiculoSel = (this.cmbVehiculo.SelectedItem as Modelo);
            if (VehiculoSel == null)
            {
                // this.cmbMarca.SelectedIndex = -1;
            }
            ...
            {
                var oMarca = Datos.GetEntity<Marca>(q => q.MarcaID == VehiculoSel.MarcaID);
        ...
        private void tacVehiculo_SeleccionCambiada(object sender, EventArgs e)
        {
            ...
            int iModeloID = Util.Entero(this.tacVechiculo.ValorSel);
            var oSel = Datos.GetEntity<Modelo>(c => c.ModeloID == iModeloID && c.Estatus);
            if (oSel == null)
            {
                // this.cmbMarca.SelectedIndex = -1;
            }
            ...
            {
                var oMarca = Datos.GetEntity<Marca>(q => q.MarcaID == oSel.MarcaID);
                this.cmbMarca.Text = oMarca.NombreMarca;
        ...
        {
            var iMarcaID = Util.Entero(this.cmbMarca.SelectedValue);
            this.cmbModelo.DataSource = Datos.GetListOf<Modelo>(q => q.Estatus && q.MarcaID == iMarcaID).OrderBy(o => o.NombreModelo).ToList();
        ...
        {
            var iModeloID = Util.Entero(this.cmbModelo.SelectedValue);
            this.cmbAnio.DataSource = Datos.GetListOf<ModelosAniosView>(q => q.ModeloID == iModeloID).OrderBy(o => o.Anio).ToList();
            this.cmbAnio.SelectedIndex = -1;
        ...
        {
            var iModeloID = Util.Entero(this.cmbModelo.SelectedValue);
            var iAnio = Util.Entero(this.cmbAnio.SelectedValue);
            this.cmbMotor.DataSource = Datos.GetListOf<MotoresAniosView>(q => q.ModeloID == iModeloID && q.Anio == iAnio).OrderBy(o => o.NombreMotor).ToList();
            this.cmbMotor.SelectedIndex = -1;
        ...
        private void btnAplicarVehiculo_Click(object sender, EventArgs e)
        {
            ...
            AplicarPartesAVehiculo frmAplicar = new AplicarPartesAVehiculo(new Vehiculo()
            {
                ...
                , ModeloID = Util.Entero(this.cmbModelo.SelectedValue)
                , Anio = Util.Entero(this.cmbAnio.SelectedValue)
                , MotorID = Util.Entero(this.cmbMotor.SelectedValue)
            ...
            switch (e.KeyCode)
            {
                ...
                case Keys.Enter:
                    ...
                    if (frmCantidad.ShowDialog(Principal.Instance) == DialogResult.OK)
                        this.ModificarCantidad(this.dgvProductos.SelectedRows[0], Util.Decimal(frmCantidad.Valor));
        ...
        private void cmbLinea_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.cmbLinea.Focused)
            {
                ...
                var oMarcasPartes = Datos.GetListOf<MarcaParte>(c => c.Estatus).OrderBy(o => o.NombreMarcaParte).ToList();
                int iLineaID = Util.Entero(this.cmbLinea.SelectedValue);
                var oLineasMarcas = Datos.GetListOf<LineaMarcaParte>(c => c.Estatus && c.LineaID == iLineaID).Select(c => c.MarcaParteID);
        ...
        private void cmbMarcaParte_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.cmbMarcaParte.Focused)
            {
                ...
                var oLineas = Datos.GetListOf<Linea>(c => c.Estatus).OrderBy(o => o.NombreLinea).ToList();
                int iMarcaID = Util.Entero(this.cmbMarcaParte.SelectedValue);
                var oLineasMarcas = Datos.GetListOf<LineaMarcaParte>(c => c.Estatus && c.MarcaParteID == iMarcaID).Select(c => c.LineaID);
        ...
        {
            decimal mTotalActual = Util.Decimal(this.lblTotal.Text.SoloNumeric());
        ...
        {
            return Util.Entero(Elemento.SubItems[5].Text);
        }
        ...
        private void BusquedaAvanzada()
        {
            ...
            else
            {
                ...
                if (this.cmbSistema.SelectedIndex >= 0)
                    Filtros.Add("SistemaID", Util.Entero(this.cmbSistema.SelectedValue));
                if (this.cmbLinea.SelectedIndex >= 0)
                    Filtros.Add("LineaID", Util.Entero(this.cmbLinea.SelectedValue));
                if (this.cmbMarcaParte.SelectedIndex >= 0)
                    Filtros.Add("MarcaID", Util.Entero(this.cmbMarcaParte.SelectedValue));
                ...
                */
                ...
                foreach (Control oControl in this.flpCaracteristicas.Controls)
                {
                    ...
                    {
                        // Filtros.Add(Util.ConvertirCadena(oControl.Tag), oControl.Text);
                ...
                if (this.chkBusquedaPorAplicacion.Checked)
                {
                    if (this.cmbModelo.SelectedIndex >= 0)
                        Filtros.Add("VehiculoModeloID", Util.Entero(this.cmbModelo.SelectedValue));
                    if (this.cmbAnio.SelectedIndex >= 0)
                        Filtros.Add("VehiculoAnio", Util.Entero(this.cmbAnio.SelectedValue));
                    if (this.cmbMotor.SelectedIndex >= 0)
                        Filtros.Add("VehiculoMotorID", Util.Entero(this.cmbMotor.SelectedValue));
                }
        ...
        private void MostrarComplementarios(int iParteID)
        {
            ...
            foreach (var Parte in oPartesCom)
            {
                ...
                //
                var oParteEx = Datos.GetListOf<ParteExistencia>(c => c.ParteID == Parte.ParteIDComplementaria && c.Estatus);
        ...
        private void MostrarEquivalentes(int iParteID)
        {
            ...
            var PartesEq = Datos.GetListOf<PartesEquivalentesView>(q => q.ParteID == iParteID);
            ...
            foreach (var Parte in PartesEq)
            {
                ...
                //
                var oParteEx = Datos.GetListOf<ParteExistencia>(c => c.ParteID == Parte.ParteIDEquivalente && c.Estatus);
                var oParteBusqueda = new pauVentasPartesBusqueda_Result()
                {
        ...
        private void MostrarDatosParteSeleccionada(int iParteID)
        {
            ...
            //
            var oParte = Datos.GetEntity<PartesVentasView>(q => q.ParteID == iParteID);
        ...
        private void ComprobarPrecioCaducado(int iparteID)
        {
            ...
            if (Datos.Exists<ParteMaxMin>(c => c.ParteID == iparteID && (!c.Maximo.HasValue || c.Maximo == 0) && (!c.Minimo.HasValue || c.Minimo == 0)))
            {
                if (Datos.Exists<Parte>(pp => pp.ParteID == iparteID && pp.FechaRegistro < fechaMesPasado && pp.Estatus))
                {
        ...
        {
            var oCaracteristicasV = Datos.GetListOf<PartesCaracteristicasView>(c => c.ParteID == iParteID);
        ...
        { 
            var oCodigos = Datos.GetListOf<PartesCodigosAlternosView>(c => c.ParteID == iParteID);
        ...
        {
            var oDatos = Datos.GetListOf<PartesVehiculosView>(c => c.ParteID == iParteID);
            this.dgvAplicaciones.Rows.Clear();
            foreach (var oReg in oDatos)
                this.dgvAplicaciones.Rows.Add(oReg.ParteID, oReg.NombreModelo, Util.Cadena(oReg.Anio).Derecha(2), oReg.NombreMotor);
        }
        ...
        private void DibujarParteLista(DrawListViewItemEventArgs e)
        {
            ...
            if (this.oCantImagenes.ContainsKey(oParte.ParteID.Valor()) && this.oCantImagenes[oParte.ParteID.Valor()] > 1)
        ...
        {
            int iClienteID = Util.Entero(this.tacCliente.ValorSel);
        ...
        public bool Validar()
        {
            ...
            {
                Util.MensajeAdvertencia("No hay ningún producto seleccionado.", GlobalClass.NombreApp);
                return false;
            }
