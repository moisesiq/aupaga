...
namespace Refaccionaria.App
{
    public partial class Master : UserControl
    {
        ...
        private void Master_Load(object sender, EventArgs e)
        {
            ...
            var oProveedores = Datos.GetListOf<Proveedor>(c => c.Estatus).OrderBy(c => c.NombreProveedor).ToList();
            ...
            var oMarcas = Datos.GetListOf<MarcaParte>(c => c.Estatus).OrderBy(c => c.NombreMarcaParte).ToList();
            ...
            var oLineas = Datos.GetListOf<Linea>(c => c.Estatus).OrderBy(c => c.NombreLinea).ToList();
            ...
            this.UnidadDeMedidaID.DataSource = Datos.GetListOf<Medida>(q => q.Estatus);
        ...
        private void CargarDatos()
        {
            ...
            //
            var oDatos = Datos.ExecuteProcedure<pauPartesMaster_Res>("pauPartesMaster", oParams);
        ...
        private void MarcarCambioCelda(DataGridViewCell oCelda)
        {
            ...
            if (sColumna == "Precio1" || sColumna == "Precio2" || sColumna == "Precio3" || sColumna == "Precio4" || sColumna == "Precio5")
            {
                ...
                decimal mDiferencia = (Util.Decimal(oCelda.Value) - Util.Decimal(oCeldaMod.Value));
                if (mDiferencia == 0)
        ...
        private void AplicarCheck(string sColumna)
        {
            ...
            foreach (DataGridViewRow Fila in this.dgvDatos.Rows)
            {
                if (sColumna != "Procesar" && !Util.Logico(Fila.Cells["Procesar"].Value)) continue;
                if (bMarcado == null)
                    bMarcado = !Util.Logico(Fila.Cells[sColumna].Value);
        ...
        private void BuscarReemplazar(string sColumna)
        {
            ...
            foreach (DataGridViewRow Fila in this.dgvDatos.Rows)
            {
                ...
                sValor = Util.Cadena(Fila.Cells[sColumna].Value).ToUpper();
