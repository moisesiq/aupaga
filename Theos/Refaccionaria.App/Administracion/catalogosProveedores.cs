...
namespace Refaccionaria.App
{
    public partial class catalogosProveedores : UserControl
    {
        ...
        */
            ...
            else
            {
                if (Proveedor.ProveedorID > 0)
                {
                    try
                    {
                        ...
                        this.npdDiasPlazo.Value = Proveedor.DiasPlazo.Equals(null) ? 0 : Util.Entero(Proveedor.DiasPlazo);

                        if (Proveedor.PaqueteriaID > 0)
                            this.cboPaqueteria.SelectedValue = Proveedor.PaqueteriaID;

                        this.nudCalendarioPedido.Value = Proveedor.CalendarioPedido == null ? 0 : Util.Entero(Proveedor.CalendarioPedido);
                        ...
                        this.chkUsarDescuentosItemFactura.Checked = Proveedor.UsarDescuentosItemFactura == null ? false : Util.Logico(Proveedor.UsarDescuentosItemFactura);
                        ...
                        this.chkCobraSeguro.Checked = Proveedor.CobraSeguro == null ? false : Util.Logico(Proveedor.CobraSeguro);
                        this.txtSeguro.Text = Proveedor.Seguro == null ? "0.0" : Proveedor.Seguro.ToString();
                        this.chkAceptaDevolucion.Checked = Proveedor.AceptaDevolucionSeguro == null ? false : Util.Logico(Proveedor.AceptaDevolucionSeguro);
        ...
        public void CargaInicial()
        {
            ...
            try
            {
                ...
                this.LimpiarFormulario();
                var provEstatus = Datos.GetListOf<ProveedorEstatus>(p => p.Estatus.Equals(true));
                ...
                var listaPaqueteria = Datos.GetListOf<ProveedorPaqueteria>(p => p.Estatus.Equals(true));
                ...
                this.cboPaqueteria.TextUpdate += new EventHandler(UtilLocal.cboCharacterCasingUpper);
        ...
        public void ActualizarListado()
        {
            try
            {
                ...
                if (int.TryParse(cboFiltro.SelectedValue.ToString(), out id))
                {
                    ...
                    this.fuenteDatos.DataSource = UtilLocal.newTable<ProveedoresView>("Proveedores", Datos.GetListOf<ProveedoresView>(p => p.ProveedorID > 0 && p.ProveedorEstatusID.Equals(id)));
                    this.dgvDatos.DataSource = this.fuenteDatos;
                    this.dgvDatos.AutoResizeColumns();
                    Util.OcultarColumnas(this.dgvDatos, new string[] { "ProveedorID", "RFC", "Direccion", "Ciudad", "Estado", "CP", "TelUno", "TelDos", "TelTres", "PaginaWeb", "DiasPlazo", "ProveedorEstatusID", "FechaRegistro", "Busqueda", "EntityState", "EntityKey" });
        ...
        public void CargarMarcas(int proveedorId)
        {
            try
            {
                ...
                this.dgvMarcas.DataSource = null;
                var marcas = UtilLocal.newTable<ProveedorMarcaPartesView>("Marcas", Datos.GetListOf<ProveedorMarcaPartesView>(p => p.ProveedorID.Equals(proveedorId)).ToList());
                
                this.dgvMarcas.DataSource = marcas;
                Util.OcultarColumnas(this.dgvMarcas, new string[] { "ProveedorMarcaParteID", "ProveedorID", "EntityKey", "EntityState" });
                UtilLocal.ColumnasToHeaderText(this.dgvMarcas);
        ...
        public void CargarProntoPago(int proveedorId)
        {
            try
            {
                this.dgvProntoPago.DataSource = Datos.GetListOf<ProveedorProntoPagosView>(p => p.ProveedorID.Equals(proveedorId));
                Util.OcultarColumnas(this.dgvProntoPago, new string[] { "ProveedorProntoPagoID", "ProveedorID" });
                UtilLocal.ColumnasToHeaderText(this.dgvProntoPago);
        ...
        public void CargarGanancias(int proveedorId)
        {
            try
            {
                ...
                var listaGanancias = Datos.GetListOf<ProveedorGananciasView>(p => p.ProveedorID.Equals(proveedorId)).ToList();
                ...
                Util.OcultarColumnas(this.dgvGanancias, new string[] { "ProveedorGananciaID", "ProveedorID", "LineaID", "LineaMarca", "MarcaParteID" });
                UtilLocal.ColumnasToHeaderText(this.dgvGanancias);
        ...
        private void dgvMarcas_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (this.dgvMarcas.CurrentRow == null)
                return;
            DetalleProveedorMarcaParte m = new DetalleProveedorMarcaParte(Util.Entero(this.dgvMarcas.CurrentRow.Cells["ProveedorMarcaParteID"].Value));
            m.ProveedorId = Proveedor.ProveedorID;
            m.ShowDialog();
            if (m.DialogResult == DialogResult.OK)
            {
        ...
        private void dgvMarcas_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                {
                    var res = Util.MensajePregunta("¿Está seguro de que desea eliminar la relación con ésta Marca?", GlobalClass.NombreApp);
                    if (res == DialogResult.Yes)
                    {
                        var fila = this.dgvMarcas.CurrentRow.Index;
                        var proveedorMarcaParteID = Util.Entero(this.dgvMarcas.Rows[fila].Cells["ProveedorMarcaParteID"].Value);
                        var proveedorMarcaParte = Datos.GetEntity<ProveedorMarcaParte>(p => p.ProveedorMarcaParteID.Equals(proveedorMarcaParteID));
                        if (proveedorMarcaParte != null)
                        {
                            Datos.Delete<ProveedorMarcaParte>(proveedorMarcaParte);

                            var res2 = Util.MensajePregunta("¿Desea eliminar la relación de ésta Marca con todas las Lineas registradas en el módulo de Ganancias?", GlobalClass.NombreApp);
                            if (res2 == DialogResult.Yes)
                            {
                                var ganancias = Datos.GetListOf<ProveedorGanancia>(p => p.ProveedorID == proveedorMarcaParte.ProveedorID
                                    && p.MarcaParteID == proveedorMarcaParte.MarcaParteID
                                    && p.Estatus);
                                foreach (var ganancia in ganancias)
                                {
                                    Datos.Delete<ProveedorGanancia>(ganancia);
                                }
                            }
                        }
        ...
        private void dgvProntoPago_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Delete)
            {
                var res = Util.MensajePregunta("¿Está seguro de que desea eliminar la relación con el registro de pronto pago?", GlobalClass.NombreApp);
                if (res == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        var proveedorProntoPagoID = Util.Entero(dg.Rows[fila].Cells["ProveedorProntoPagoID"].Value);
                        var proveedorProntoPago = Datos.GetEntity<ProveedorProntoPago>(p => p.ProveedorProntoPagoID.Equals(proveedorProntoPagoID));
                        if (proveedorProntoPago != null)
                        {
                            Datos.Delete<ProveedorProntoPago>(proveedorProntoPago);
                            this.CargarProntoPago(Proveedor.ProveedorID);
                        }
                    }
                    catch (Exception ex)
        ...
        private void dgvGanancias_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //    return;
            //DetalleProveedorGanancia m = new DetalleProveedorGanancia(Util.ConvertirEntero(this.dgvGanancias.CurrentRow.Cells["ProveedorGananciaID"].Value));
            //m.ProveedorId = Proveedor.ProveedorID;
            //m.ShowDialog();
        }
        ...
        private void dgvGanancias_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Delete)
            {
                var res = Util.MensajePregunta("¿Está seguro de que desea eliminar la relación con esta marca?", GlobalClass.NombreApp);
                if (res == DialogResult.Yes)
                {
                    try
                    {
                        var fila = this.dgvGanancias.CurrentRow.Index;
                        var proveedorGananciaID = Util.Entero(this.dgvGanancias.Rows[fila].Cells["ProveedorGananciaID"].Value);
                        var proveedorGanancia = Datos.GetEntity<ProveedorGanancia>(p => p.ProveedorGananciaID.Equals(proveedorGananciaID));
                        if (proveedorGanancia != null)
                        {
                            Datos.Delete<ProveedorMarcaParte>(proveedorGanancia);
                            this.CargarGanancias(Proveedor.ProveedorID);
                        }
                    }
                    catch (Exception ex)
        ...
        private void btnGuardarGanancias_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (DataGridViewRow row in this.dgvGanancias.Rows)
                {
                    ...
                    {
                        var proveedorGananciaId = Util.Entero(row.Cells["ProveedorGananciaID"].Value);
                        var ganancia = Datos.GetEntity<ProveedorGanancia>(p => p.ProveedorGananciaID == proveedorGananciaId);
                        if (ganancia != null)
                        {
                            ganancia.PorcentajeUno = Util.Decimal(row.Cells["PCT1"].Value);
                            ganancia.PorcentajeDos = Util.Decimal(row.Cells["PCT2"].Value);
                            ganancia.PorcentajeTres = Util.Decimal(row.Cells["PCT3"].Value);
                            ganancia.PorcentajeCuatro = Util.Decimal(row.Cells["PCT4"].Value);
                            ganancia.PorcentajeCinco = Util.Decimal(row.Cells["PCT5"].Value);
        ...
        private void dgvMovimientosNoPagados_CurrentCellChanged(object sender, EventArgs e)
        {
            if (this.dgvMovimientosNoPagados.VerSeleccionNueva())
            {
                ...
                int iMovID = Util.Entero(this.dgvMovimientosNoPagados.CurrentRow.Cells["pen_MovimientoInventarioID"].Value);
                this.CargarAbonos(this.dgvAbonos, iMovID);

                // Se verifica si es agrupador, para cargar los movimientos correspondientes
                if (Util.Logico(this.dgvMovimientosNoPagados.CurrentRow.Cells["pen_EsAgrupador"].Value))
        ...
        private void btnAgregarPoliza_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (!Util.Logico(row.Cells["pen_Sel"].Value))
                        continue;

                    int iMovID = Util.Entero(row.Cells["pen_MovimientoInventarioID"].Value);
                    if (Util.Logico(row.Cells["pen_EsAgrupador"].Value))
                        ids.AddRange(Datos.GetListOf<MovimientoInventario>(c => c.MovimientoAgrupadorID == iMovID && c.Estatus).Select(c => c.MovimientoInventarioID));
                    else
                        ids.Add(iMovID);
                }
            }
            ...
            try
            {
                foreach (DataGridViewRow row in dgvDevoluciones.Rows)
                    if (Convert.ToBoolean(row.Cells["X"].Value).Equals(true))
                        ids.Add(Util.ConvertirEntero(row.Cells["DevolucionID"].Value));

                if (ids.Count < 1) return;

                var movimientoDestinoID = Util.ConvertirEntero(this.dgvMovimientosNoPagados.CurrentRow.Cells["pen_MovimientoInventarioID"].Value);
                ...
                var res = Util.MensajePregunta(pregunta, GlobalClass.NombreApp);
                if (res == DialogResult.No)
                    return;
                ...
                {
                    var devolucion = General.GetEntity<MovimientoInventario>(m => m.MovimientoInventarioID == movimientoOrigenID);
                    if (devolucion != null)
                    {
                        ...
                        General.SaveOrUpdate<MovimientoInventario>(devolucion, devolucion);
                    }
                }
                //DUDA
                ...
                var movimiento = General.GetEntity<MovimientoInventario>(m => m.MovimientoInventarioID == movimientoDestinoID);
                decimal pagos = 0;
                var listaPagosParcialesYdevoluciones = General.GetListOf<ProveedorPagosYdevolucionesView>(p => p.MovimientoInventarioID == movimientoDestinoID && p.ProveedorID == Proveedor.ProveedorID);
        ...
        private void dgvNotasDeCredito_CurrentCellChanged(object sender, EventArgs e)
        {
            ...
            {
                this.txtNdcObservacion.Text = Util.Cadena(this.dgvNotasDeCredito.CurrentRow.Cells["ndc_Observacion"].Value);
            }
        }

        public void CargarMovimientosNoPagados(int proveedorId)
        {
            var oPendientes = Datos.GetListOf<ProveedoresComprasView>(m => m.ProveedorID == Proveedor.ProveedorID && m.Saldo > 0 && !m.MovimientoAgrupadorID.HasValue);
        ...
        {
            var oAbonos = Datos.GetListOf<ProveedoresPolizasDetalleAvanzadoView>(c => c.MovimientoInventarioID == iMovimientoID);
            oGrid.Rows.Clear();
        ...
        {
            var oNotas = Datos.GetListOf<ProveedoresNotasDeCreditoView>(c => c.ProveedorID == iProveedorID && c.Disponible);
        ...
        {
            var oMovs = Datos.GetListOf<ProveedoresComprasView>(c => c.MovimientoAgrupadorID == iMovID);
            this.dgvAgrupadosNoPagados.Rows.Clear();
        ...
        private void DesagruparMovimientos(int iMovimientoAgrupadorID)
        {
            ...
            var oMovs = Datos.GetListOf<MovimientoInventario>(c => c.MovimientoAgrupadorID == iMovimientoAgrupadorID);
            foreach (var oReg in oMovs)
            {
                oReg.MovimientoAgrupadorID = null;
                Datos.Guardar<MovimientoInventario>(oReg);
            }
            var oMovAgr = Datos.GetEntity<MovimientoInventario>(c => c.MovimientoInventarioID == iMovimientoAgrupadorID && c.EsAgrupador && c.Estatus);
            Datos.Eliminar<MovimientoInventario>(oMovAgr);
        ...
        public void CargarOperaciones(int proveedorId, DateTime fechaIncial, DateTime fechaFinal)
        {
            ...
            if (Modo != 2)
            {
                ...
                {
                    Util.MensajeError("La Fecha Inicial no puede ser mayor a la Fecha Final ó viceversa.", GlobalClass.NombreApp);
                    return;
                }
            }
            ...
            var oCompras = Datos.GetListOf<ProveedoresComprasView>(c => c.ProveedorID == proveedorId && c.Fecha >= fechaIncial && c.Fecha < fechaFinal);
        ...
        public void CargarDetalleOperacion(int movimientoInventarioId)
        {
            try
            {
                ...
                var opers = Datos.GetListOf<ProveedorKardexDetalleOperacionesView>(o => o.MovimientoInventarioID.Equals(movimientoInventarioId));
                this.dgvDetalleOperaciones.DataSource = opers;
                Util.OcultarColumnas(this.dgvDetalleOperaciones, new string[] { "MovimientoInventarioDetalleID", "MovimientoInventarioID" });
                UtilLocal.ColumnasToHeaderText(this.dgvDetalleOperaciones);
        ...
        public void CargarProductosComprados(int proveedorId, DateTime fechaIncial, DateTime fechaFinal)
        {
            ...
            try
            {
                ...
                if (Modo == 2)
                {
                    prods = Datos.GetListOf<ProveedorProductosCompradosView>(o => o.ProveedorID == Proveedor.ProveedorID);
                }
                else
                {
                    prods = Datos.GetListOf<ProveedorProductosCompradosView>(o => o.ProveedorID == Proveedor.ProveedorID && (o.FechaRecepcion >= fechaIncial && o.FechaRecepcion <= fechaFinal));
                }
                ...
                Util.OcultarColumnas(this.dgvProductosComprados, new string[] { "ParteID" });
                UtilLocal.ColumnasToHeaderText(this.dgvProductosComprados);
                ...
                {
                    sumaImporte += Util.Decimal(fila.Cells["Importe"].Value);
                }
                ...
                //labelDgvSumaImporte.Text = Util.DecimalToCadenaMoneda(sumaImporte);
        ...
        public void CargarDetalleDocumentos(int parteId)
        {
            try
            {
                ...
                var docs = Datos.GetListOf<ProveedorDetalleDocumentosView>(o => o.ProveedorID == Proveedor.ProveedorID && o.ParteID == parteId);
                this.dgvDetalleDocumentos.DataSource = docs;
                Util.OcultarColumnas(this.dgvDetalleDocumentos, new string[] { "MovimientoInventarioDetalleID", "MovimientoInventarioID", "ProveedorID", "ParteID" });
                UtilLocal.ColumnasToHeaderText(this.dgvDetalleDocumentos);
        ...
        public void CargarDetalleDocumentos(int parteId, DateTime fechaInicial, DateTime fechaFinal)
        {
            try
            {
                ...
                var docs = Datos.GetListOf<ProveedorDetalleDocumentosView>(o => o.ProveedorID == Proveedor.ProveedorID && o.ParteID == parteId && o.Fecha>=fechaInicial && o.Fecha<=fechaFinal);
                this.dgvDetalleDocumentos.DataSource = docs;
                Util.OcultarColumnas(this.dgvDetalleDocumentos, new string[] { "MovimientoInventarioDetalleID", "MovimientoInventarioID", "ProveedorID", "ParteID" });
                UtilLocal.ColumnasToHeaderText(this.dgvDetalleDocumentos);
        ...
        private void dgvOperaciones_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            try
            {
                if (e.KeyCode == Keys.F12)
                {
                    ...
                    {
                        UtilLocal.OnExportGridToCSV(this.dgvOperaciones, saveDialog.FileName.ToString());
                    }
                }
            }
            catch (Exception ex)
        ...
        private void dgvOperaciones_CurrentCellChanged(object sender, EventArgs e)
        {
            if (this.dgvOperaciones.VerSeleccionNueva())
            {
                ...
                {
                    int iMovID = Util.Entero(this.dgvOperaciones.CurrentRow.Cells["com_MovimientoInventarioID"].Value);
        ...
        private void dgvAbonosKardex_CurrentCellChanged(object sender, EventArgs e)
        {
            if (this.dgvOperaciones.VerSeleccionNueva())
            {
                ...
                {
                    int iMovID = Util.Entero(this.dgvOperaciones.CurrentRow.Cells["MovimientoInventarioID"].Value);
                    this.CargarDetalleOperacion(iMovID);
                    this.CargarAbonos(this.dgvAbonosKardex, iMovID);
                }
            }
        ...
        private void smiCambiarFolio_Click(object sender, EventArgs e)
        {
            ...
            int iAbonoID = Util.Entero(this.dgvAbonosKardex.CurrentRow.Cells["abk_ProveedorPolizaDetalleID"].Value);
        ...
        private void dgvProductosComprados_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (this.dgvProductosComprados.CurrentRow == null)
                return;
            var parteId = Util.Entero(this.dgvProductosComprados.CurrentRow.Cells["ParteID"].Value);
            if (parteId > 0)
            {
        ...
        private void dgvProductosComprados_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                if (e.KeyCode == Keys.F12)
                {
                    ...
                    if (saveDialog.ShowDialog() == DialogResult.OK)
                    {
                        UtilLocal.OnExportGridToCSV(this.dgvProductosComprados, saveDialog.FileName.ToString());
                    }
                }
            }
            catch (Exception ex)
        ...
        private void CambiarFolioAbono(int iAbonoID)
        {
            ...
            string sFolio = Util.Cadena(oNuevo);
            ...
            var oPoliza = Datos.GetEntity<ContaPoliza>(c => c.RelacionTabla == Cat.Tablas.ProveedorPolizaDetalle && c.RelacionID == oAbono.ProveedorPolizaDetalleID);
            var oPolizaDet = Datos.GetListOf<ContaPolizaDetalle>(c => c.ContaPolizaID == oPoliza.ContaPolizaID);
            ...
            {
                var oNotaP = Datos.GetEntity<ProveedorNotaDeCredito>(c => c.ProveedorNotaDeCreditoID == oAbono.NotaDeCreditoID);
                oNotaP.Folio = sFolio;
                Datos.Guardar<ProveedorNotaDeCredito>(oNotaP);
            }
        }
        ...
        */
        ...
        {
            var oCompras = Datos.GetListOf<ProveedoresComprasView>(c => c.Saldo > 0 && !c.MovimientoAgrupadorID.HasValue);
        ...
        private void CargarListaVencimientos(int iProveedorID)
        {
            ...
            if (dFinMas1 < dFinalMax)
                dFinMas1 = dFinalMax;
            //
            var oCompras = Datos.GetListOf<ProveedoresComprasView>(c => c.Saldo > 0 && !c.MovimientoAgrupadorID.HasValue && c.Fecha < dFinMas1);
            ...
            foreach (var oReg in oComprasA)
            {
                ...
                // Se llena el total
                oNodoDia.Cells["cpp_Importe"].Value = (Util.Decimal(oNodoDia.Cells["cpp_Importe"].Value) + oReg.Saldo.Valor());
            }
            // Se llena el acumulado
            mSaldoAcum = mSaldoIni;
            foreach (TreeGridNode oNodo in this.tgvCuentasPorPagar.Nodes)
            {
                mSaldoAcum += Util.Decimal(oNodo.Cells["cpp_Importe"].Value);
        ...
        private void btnGarNoProcedio_Click(object sender, EventArgs e)
        {
            ...
            if (Util.Entero(this.dgvGarantias.CurrentRow.Cells["garEstatusGenericoID"].Value) != Cat.EstatusGenericos.EnRevision)
                return;
            ...
            int iGarantiaID = Util.Entero(this.dgvGarantias.CurrentRow.Cells["garVentaGarantiaID"].Value);
            this.GarantiasMarcarNoProcedio(iGarantiaID, Util.Cadena(oMotivo));
        }
        ...
        private void LlenarGarantias(int iProveedorID)
        {
            ...
            var oGarantias = Datos.GetListOf<VentasGarantiasView>(c => c.ProveedorID == iProveedorID
                && (bMostrarTodas || c.EstatusGenericoID == Cat.EstatusGenericos.EnRevision));
            this.dgvGarantias.Rows.Clear();

            var todas = Datos.GetListOf<ProveedorNotaDeCredito>(c => c.VentaGarantiaID.HasValue);
        ...
        private void LlenarGarantiasNotaDeCredito(DataGridViewRow oFila)
        {
            ...
            {
                var oNota = Datos.GetEntity<ProveedorNotaDeCredito>(c => c.ProveedorNotaDeCreditoID == oGarantiaV.ProveedorNotaDeCreditoID);
        ...
        private void GarantiasNotaDeCredito()
        {
            ...
            {
                if (!Util.Logico(oFila.Cells["garSel"].Value))
                    continue;
                if (Util.Entero(oFila.Cells["garEstatusGenericoID"].Value) == Cat.EstatusGenericos.EnRevision)
                    oGarantias.Add(Util.Entero(oFila.Cells["garVentaGarantiaID"].Value));
                else
            ...
            if (oGarantias.Count > 0)
            {
                ...
                int aux = Util.Entero(oGarantias.ElementAt(0));
                var eMovInId = Datos.GetEntity<ProveedorNotaDeCredito>(c => c.VentaGarantiaID == aux);
                if (eMovInId != null)
                {
                    UtilLocal.MensajeInformacion("Ya se ha generado previamente una nota de crédito");
                    return;
                }
        ...
        public void CargarDevoluciones(int proveedorId)
        {
            ...
            var devs = Datos.GetListOf<MovimientoInventario>(c => c.ProveedorID == Proveedor.ProveedorID
            ...
            var todas = Datos.GetListOf<ProveedorNotaDeCredito>(c => c.MovimientoInventarioID.HasValue);
        ...
        private void LlenarDetalleDevolucion()
        {
            ...
            int iDevID = Util.Entero(this.dgvDevoluciones.CurrentRow.Cells["des_MovimientoInventarioID"].Value);
            var oDetalle = Datos.GetListOf<MovimientosInventarioDetalleAvanzadoView>(c => c.MovimientoInventarioID == iDevID);
        ...
        private void DevolucionesNotasDeCredito()
        {
            ...
            {
                if (!Util.Logico(oFila.Cells["des_Sel"].Value))
                    continue;
                oDevs.Add(Util.Entero(oFila.Cells["des_MovimientoInventarioID"].Value));
                MovInID = Util.Entero(oFila.Cells["des_MovimientoInventarioID"].Value);
            }

            var eMovInId = Datos.GetEntity<ProveedorNotaDeCredito>(c => c.MovimientoInventarioID == MovInID);
            if (eMovInId != null)
            {
                UtilLocal.MensajeInformacion("Ya se ha generado previamente una nota de crédito");
                return;
            ...
            if (oDevs.Count > 0)
            {
                ...
                if (frmNotaDeCredito.ShowDialog(Principal.Instance) == DialogResult.OK)
                {
                    ...
                    var oNotaC = new ProveedorNotaDeCredito()
                    {
                        ...
                        Observacion = frmNotaDeCredito.Observacion,
                        MovimientoInventarioID = MovInID
                    };
                    
                    var oNota = AdmonProc.CrearNotaDeCreditoProveedor(oNotaC);
        ...
        private void tgvDescGan_CurrentCellChanged(object sender, EventArgs e)
        {
            if (this.tgvDescGan.VerSeleccionNueva())
            {
                if (this.tgvDescGan.CurrentNode == null)
                    ...
                    this.txtDescGanObservacion.Text = Util.Cadena(this.tgvDescGan.CurrentNode.Cells["dcgObservacion"].Value);
            }
        }
        ...
        private void CargarDescuentosGanancias(int iProveedorID)
        {
            ...
            var oDatos = Datos.GetListOf<ProveedoresPartesGananciasLineasView>(c => c.ProveedorID == iProveedorID)
        ...
        private void CargarPartesLinea(TreeGridNode oNodo)
        {
            ...
            int iLineaID = Util.Entero(oNodo.Cells["dcgId"].Value);
            int iMarcaID = Util.Entero(oNodo.Parent.Cells["dcgId"].Value);
            int iProveedorID = Util.Entero(oNodo.Parent.Parent.Cells["dcgId"].Value);
            var oDatos = Datos.GetListOf<ProveedoresPartesGananciasView>(c => c.ProveedorID == iProveedorID && c.MarcaID == iMarcaID && c.LineaID == iLineaID
        ...
        private void GuardarDescuentosGanancias()
        {
            ...
            foreach (DataGridViewRow oFila in this.tgvDescGan.Rows)
            {
                ...
                int iParteGananciaID = Util.Entero(oNodo.Cells["dcgProveedorParteGananciaID"].Value);
                ProveedorParteGanancia oParteGanancia;
                if (iParteGananciaID > 0)
                {
                    oParteGanancia = Datos.GetEntity<ProveedorParteGanancia>(c => c.ProveedorParteGananciaID == iParteGananciaID);
                }
                else
                {
                ...
                if (oNodo.Cells["dcgDescuentoFactura1"].Tag != null)
                    oParteGanancia.DescuentoFactura1 = Util.Decimal(oNodo.Cells["dcgDescuentoFactura1"].Value);
                if (oNodo.Cells["dcgDescuentoFactura2"].Tag != null)
                    oParteGanancia.DescuentoFactura2 = Util.Decimal(oNodo.Cells["dcgDescuentoFactura2"].Value);
                if (oNodo.Cells["dcgDescuentoFactura3"].Tag != null)
                    oParteGanancia.DescuentoFactura3 = Util.Decimal(oNodo.Cells["dcgDescuentoFactura3"].Value);
                if (oNodo.Cells["dcgDescuentoArticulo1"].Tag != null)
                    oParteGanancia.DescuentoArticulo1 = Util.Decimal(oNodo.Cells["dcgDescuentoArticulo1"].Value);
                if (oNodo.Cells["dcgDescuentoArticulo2"].Tag != null)
                    oParteGanancia.DescuentoArticulo2 = Util.Decimal(oNodo.Cells["dcgDescuentoArticulo2"].Value);
                if (oNodo.Cells["dcgDescuentoArticulo3"].Tag != null)
                    oParteGanancia.DescuentoArticulo3 = Util.Decimal(oNodo.Cells["dcgDescuentoArticulo3"].Value);
                if (oNodo.Cells["dcgPorcentajeDeGanancia1"].Tag != null)
                    oParteGanancia.PorcentajeDeGanancia1 = Util.Decimal(oNodo.Cells["dcgPorcentajeDeGanancia1"].Value);
                if (oNodo.Cells["dcgPorcentajeDeGanancia2"].Tag != null)
                    oParteGanancia.PorcentajeDeGanancia2 = Util.Decimal(oNodo.Cells["dcgPorcentajeDeGanancia2"].Value);
                if (oNodo.Cells["dcgPorcentajeDeGanancia3"].Tag != null)
                    oParteGanancia.PorcentajeDeGanancia3 = Util.Decimal(oNodo.Cells["dcgPorcentajeDeGanancia3"].Value);
                if (oNodo.Cells["dcgPorcentajeDeGanancia4"].Tag != null)
                    oParteGanancia.PorcentajeDeGanancia4 = Util.Decimal(oNodo.Cells["dcgPorcentajeDeGanancia4"].Value);
                if (oNodo.Cells["dcgPorcentajeDeGanancia5"].Tag != null)
                    oParteGanancia.PorcentajeDeGanancia5 = Util.Decimal(oNodo.Cells["dcgPorcentajeDeGanancia5"].Value);
                ...
                if (oNodo.Cells["dcgObservacion"].Tag != null)
                {
                    ...
                    oParteGanancia.Observacion += string.Format("{0} / {1} / {2}", DateTime.Now, GlobalClass.UsuarioGlobal.NombreUsuario
                        , Util.Cadena(oNodo.Cells["dcgObservacion"].Value));
                }

                Datos.Guardar<ProveedorParteGanancia>(oParteGanancia);
            }
