...
namespace Refaccionaria.App
{
    public partial class CuadroSemanas : UserControl
    {
        ...
        private void dgvSemana_CurrentCellChanged(object sender, EventArgs e)
        {
            ...
            {
                int iSemana = (this.dgvSemana.CurrentRow == null ? 0 : Util.Entero(this.dgvSemana.CurrentRow.Cells["Semana_Id"].Value));
        ...
        private void dgvVendedorSem_CurrentCellChanged(object sender, EventArgs e)
        {
            ...
            {
                int iVendedorID = (this.dgvVendedorSem.CurrentRow == null ? 0 : Util.Entero(this.dgvVendedorSem.CurrentRow.Cells["VendedorSem_Id"].Value));
        ...
        private void CargarDatos()
        {
            ...
            var oPorVendedor = this.AgruparPorEnteroCadenaEntero(oDatos.GroupBy(g => new AgrupadoPorEnteroCadenaEntero() {
                Llave = g.VendedorID, Cadena = g.Vendedor, Entero = UtilTheos.SemanaSabAVie(g.Fecha) })).OrderBy(c => c.Entero);
