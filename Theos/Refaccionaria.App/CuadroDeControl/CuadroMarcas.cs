    ...
    public partial class CuadroMarcas : CuadroMultiple
    {
        ...
        protected override void CargarDatos()
        {
            ...
            if (this.ctlLineas.ValoresSeleccionados.Count > 0)
                oDatos = oDatos.Where(c => this.ctlLineas.ValoresSeleccionados.Contains(c.LineaID.Valor())).ToList();
        ...
        protected override void LlenarSemanas(int iId)
        {
            ...
            if (this.ActiveControl == this.dgvPrincipal)
                oConsulta = this.AgruparPorEntero(oDatos.Where(c => c.MarcaID == iId).GroupBy(g => UtilTheos.SemanaSabAVie(g.Fecha)));
            else
