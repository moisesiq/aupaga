/* Script con modificaciones a la base de datos de Theos. Archivo 001
 * Creado: 2015/04/16
 * Subido: 2015/04/16
 */
...
INSERT INTO ContaConfigAfectacion (Operacion, ContaTipoPolizaID) VALUES
	('Garantia de Venta a Crédito Facturada con Pago', 1)
	, ('Garantia de Venta a Crédito Facturada con Vale', 1)

ALTER TABLE VentaGarantia ADD VentaPagoDetalleID INT NULL REFERENCES VentaPagoDetalle(VentaPagoDetalleID)
GO
UPDATE VentaGarantia SET VentaPagoDetalleID = vpd.VentaPagoDetalleID
FROM
	VentaGarantia vg
	LEFT JOIN VentaPagoDetalle vpd ON vpd.NotaDeCreditoID = vg.NotaDeCreditoID AND Importe < 0 AND vpd.Estatus = 1
WHERE vg.NotaDeCreditoID IS NOT NULL

EXEC pauBorrarLlaveForanea 'VentaGarantia', '_NotaD_'
ALTER TABLE VentaGarantia DROP COLUMN NotaDeCreditoID
