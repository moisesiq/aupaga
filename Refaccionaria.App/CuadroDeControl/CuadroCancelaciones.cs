...
namespace Refaccionaria.App
{
    public partial class CuadroCancelaciones : CuadroMultiple
    {
        ...
        protected override void CargarDatos()
        {
            ...
            var oDatos = General.ExecuteProcedure<pauCuadroDeControlCancelaciones_Result>("pauCuadroDeControlCancelaciones", oParams);
            ...
            switch (this.cmbMostrar.SelectedIndex)
            {
                ...
                case Mostrar.Piezas:
                    ...
                    foreach (var oReg in oImportes)
                    {
                        if (bPorImporte)
                            ...
                            this.dgvPrincipal.Rows.Add(oReg.ClienteID, oReg.ClienteID, oReg.Cliente, oReg.CantidadActual, oReg.CantidadAnterior
                                , Helper.DividirONull(oReg.CantidadActual, oReg.CantidadAnterior), (Helper.DividirONull(oReg.CantidadActual, mCantidadTotal) * 100));
                    }
                    ...
                    this.dgvPrincipalTotales["PrincipalT_Resultado", 0].Value = (bPorImporte ? Helper.DividirONull(mTotal, mTotalAnt) 
                        : Helper.DividirONull(mCantidadTotal, mCantidadTotalAnt));
                    break;
                ...
                case Mostrar.Documentos:
                    ...
                    foreach (var oReg in oDoc)
                        this.dgvPrincipal.Rows.Add(oReg.ClienteID, oReg.ClienteID, oReg.Cliente, oReg.VentasActual, oReg.VentasAnterior
                            , Helper.DividirONull(oReg.VentasActual, oReg.VentasAnterior), (Helper.DividirONull(oReg.VentasActual, iTotal) * 100));
                    // Se llenan los totales
                    ...
                    this.dgvPrincipalTotales["PrincipalT_Resultado", 0].Value = Helper.DividirONull(iTotal, iTotalAnt);
                    break;

                case Mostrar.Indice:
                    // Se obtiene los datos, de ventas y de cancelaciones
                    var oDatosVentas = General.ExecuteProcedure<pauCuadroDeControlGeneral_Result>("pauCuadroDeControlGeneral", oParams);
                    ...
                    foreach (var oReg in oDevs)
                    {
                        ...
                        if (oRegVenta == null) {
                            ...
                            mIndice = Helper.DividirONull(oReg.Actual, oRegVenta.Actual);
                            mIndiceAnt = Helper.DividirONull(oReg.Anterior, oRegVenta.Anterior);
                            this.dgvPrincipal.Rows.Add(oReg.ClienteID, oReg.ClienteID, oReg.Cliente, mIndice, mIndiceAnt, Helper.DividirONull(mIndice, mIndiceAnt));
                    ...
                    this.dgvPrincipalTotales["PrincipalT_Resultado", 0].Value = Helper.DividirONull(mTotalIndice, mTotalIndiceAnt);
                    break;
            }
                ...
                case Mostrar.Indice:
                    ...
                    foreach (var oReg in oDevs)
                    {
                        ...
                        else
                        {
                            mIndice = Helper.DividirONull(oReg.Actual, oRegVenta.Actual);
                            mIndiceAnt = Helper.DividirONull(oReg.Anterior, oRegVenta.Anterior);
                            this.dgvGrupos.Rows.Add(oReg.LineaID, oReg.Linea, mIndice, mIndiceAnt, Helper.DividirONull(mIndice, mIndiceAnt));
                        }
                    }
                    break;
            }
        ...
        protected override void LlenarSemanas(int iId)
        {
            ...
            var oConsulta = oFiltro.GroupBy(g => UtilLocal.SemanaSabAVie(g.Fecha));
            ...
            switch (this.cmbMostrar.SelectedIndex)
            {
                ...
                case Mostrar.Indice:
                    ...
                    if (this.cmbTipo.SelectedIndex == Tipo.Clientes)
                        ...
                        oFiltroVen = oDatosVentas.Where(c => c.VendedorID == iId);
                    var oVentas = oFiltroVen.GroupBy(g => UtilLocal.SemanaSabAVie(g.Fecha))
                    ...
                    foreach (var oReg in oDevs)
                    {
                        ...
                        else
                        {
                            mIndice = Helper.DividirONull(oReg.Actual, oRegVenta.Actual);
                            mIndiceAnt = Helper.DividirONull(oReg.Anterior, oRegVenta.Anterior);
                            this.dgvSemanas.Rows.Add(oReg.Semana, oReg.Semana, mIndice, mIndiceAnt, Helper.DividirONull(mIndice, mIndiceAnt));
                            // Para la gráfica
                ...
                case Mostrar.Indice:
                    ...
                    foreach (var oReg in oDevs)
                    {
                        ...
                        else
                        {
                            mIndice = Helper.DividirONull(oReg.Actual, oRegVenta.Actual);
                            mIndiceAnt = Helper.DividirONull(oReg.Anterior, oRegVenta.Anterior);
                            this.dgvMeses.Rows.Add(oReg.Mes, oReg.Mes, mIndice, mIndiceAnt, Helper.DividirONull(mIndice, mIndiceAnt));
                            // Para la gráfica
                ...
                case Mostrar.Indice:
                    ...
                    foreach (var oReg in oDevs)
                    {
                        ...
                        else
                        {
                            mIndice = Helper.DividirONull(oReg.Actual, oRegVenta.Actual);
                            mIndiceAnt = Helper.DividirONull(oReg.Anterior, oRegVenta.Anterior);
                            this.dgvSucursal.Rows.Add(oReg.SucursalID, oReg.Sucursal, mIndice, mIndiceAnt, Helper.DividirONull(mIndice, mIndiceAnt));
                        }
                    }
                    break;
            }
        ...
        private void LlenarDetalle(IEnumerable<pauCuadroDeControlCancelaciones_Result> oDatos, int? iLineaID)
        {
            ...
            foreach (var oReg in oDatos)
            {
                ...
                var oVentasDetV = General.GetListOf<VentasDevolucionesDetalleView>(c => c.VentaDevolucionID == oReg.VentaDevolucionID && (iLineaID == null || c.LineaID == iLineaID));
                foreach (var oDet in oVentasDetV)
                    this.dgvPartes.Rows.Add(oReg.Fecha, oReg.Folio, oDet.NumeroParte, oDet.NombreParte
                        , ((oDet.PrecioUnitario - oDet.CostoConDescuento) * oDet.Cantidad));
            }
                ...
                case Mostrar.Indice:
                    ...
                    foreach (var oReg in oDevs)
                    {
                        ...
                        else
                        {
                            mIndice = Helper.DividirONull(oReg.Actual, oRegVenta.Actual);
                            mIndiceAnt = Helper.DividirONull(oReg.Anterior, oRegVenta.Anterior);
                            this.dgvPrincipal.Rows.Add(oReg.VendedorID, oReg.VendedorID, oReg.Vendedor, mIndice, mIndiceAnt, Helper.DividirONull(mIndice, mIndiceAnt));
