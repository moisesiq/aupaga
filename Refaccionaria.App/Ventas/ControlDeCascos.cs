...
namespace Refaccionaria.App
{
    public partial class ControlDeCascos : UserControl
    {
        ...
        {
            int iCascoRegistroID = Helper.ConvertirEntero(this.dgvPendientes.CurrentRow.Cells["CascoRegistroID"].Value);
        ...
        private void btnHisActualizar_Click(object sender, EventArgs e)
        {
            ...
            var oDatos = General.GetListOf<CascosRegistrosView>(c => c.SucursalID == iSucursalID && (c.Fecha >= dDesde && c.Fecha < dHasta));
        ...
        private void dgvHistorico_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                int iCascoRegistroID = Helper.ConvertirEntero(this.dgvHistorico.CurrentRow.Cells["hisCascoRegistroID"].Value);
                var frmAccion = new CascoRegistroCompletar(iCascoRegistroID);
                if (frmAccion.ShowDialog(Principal.Instance) == DialogResult.OK)
        ...
        public void CargarDatos()
        {
            ...
            var oDatos = General.GetListOf<CascosRegistrosView>(c => c.NumeroDeParteRecibido == null && c.FolioDeCobro == null
