...
namespace Refaccionaria.App
{
    public partial class Metas : UserControl
    {
        ...
        private void btnOcultar_Click(object sender, EventArgs e)
        {
            ...
            {
                var ResUsuario = UtilDatos.ValidarObtenerUsuario("Ventas.Comisiones.Ver");
                if (ResUsuario.Error)
                    return;
        ...
        private void CargarArbolDeGastos()
        {
            ...
            var oDatos = General.ExecuteProcedure<pauContaCuentasMovimientosTotales_Result>("pauContaCuentasMovimientosTotales", oParams);
            ...
            foreach (var oReg in oDatos)
            {
                ...
                oCuentaAuxiliar["Importe"] = (Helper.ConvertirDecimal(oCuentaAuxiliar["Importe"]) + mImporte);
                oCuentaDeMayor["Importe"] = (Helper.ConvertirDecimal(oCuentaDeMayor["Importe"]) + mImporte);
                if (oReg.SumaGastosFijos.Valor())
                    oGastosFijos["Importe"] = (Helper.ConvertirDecimal(oGastosFijos["Importe"]) + mImporte);
        ...
        {
            var oPorSemAnt = General.GetListOf<MetasComisionVendedoresView>(c => c.Anio == (this.Hasta.Year - 1) && c.VendedorID == this.UsuarioID);
            var oPorSemAct = General.GetListOf<MetasComisionVendedoresView>(c => c.Anio == this.Hasta.Year && c.VendedorID == this.UsuarioID);
        ...
        {
            var oUtilAnt = General.GetListOf<MetasUtilidadSucursalesView>(c => c.Anio == (this.Hasta.Year - 1) && c.SucursalID == this.SucursalID);
            var oUtilAct = General.GetListOf<MetasUtilidadSucursalesView>(c => c.Anio == this.Hasta.Year && c.SucursalID == this.SucursalID);
        ...
        private void CargarComisionActualMarca()
        {
            ...
            */
            ...
            if (this.oMetaVendedor.EsGerente)
            {
                ...
                decimal mPorUtil = Helper.ConvertirDecimal(Config.Valor("Comisiones.Vendedor.Porcentaje"));
        ...
        {
            var oMetaGen = General.GetEntity<MetaSucursal>(c => c.SucursalID == this.SucursalID);
        ...
        private void CargarTacometro()
        {
            ...
            this.pcbTacometroMinimo.Image = Helper.RotateImage(Properties.Resources.MetasTacometroMinimo, (float)mMarcaMinimo);
            ...
            this.pcbTacometroMarca.Image = Helper.RotateImage(oImg, (float)mAnguloPos);
        ...
        {
            var oMetas = General.GetListOf<Meta>(c => c.SucursalID == this.SucursalID && (!c.VendedorID.HasValue || c.VendedorID == this.UsuarioID));
            ...
            foreach (var oMeta in oMetas)
            {
                ...
                {
                    oDatos = General.GetListOf<VentasPartesView>(c =>
        ...
        {
            var oMetas = General.GetListOf<Meta>(c => c.SucursalID == this.SucursalID)
        ...
        private void CargarPartesPorVentas()
        {
            ...
            var oDatos = General.ExecuteProcedure<pauVentasPartesPor_Result>("pauVentasPartesPor", oParams);
        ...
        private void CompletarGraficas()
        {
            ...
            {
                var oMetasSuc = General.GetListOf<MetaSucursal>();
        ...
        {
            var oUtilAnt = General.GetListOf<MetasUtilidadSucursalesView>(c => c.Anio == (this.Hasta.Year - 1));
            var oUtilAct = General.GetListOf<MetasUtilidadSucursalesView>(c => c.Anio == this.Hasta.Year);
        ...
        {
            var oMetas = General.GetListOf<Meta>()
                .GroupBy(c => new { c.MarcaParteID, c.LineaID, c.ParteID }).Select(c => new
                {
                    c.Key.MarcaParteID,
                    c.Key.LineaID,
            ...
            var oVentas = General.GetListOf<VentasPartesView>(c => c.VentaEstatusID == Cat.VentasEstatus.Completada 
                && (c.Fecha >= this.Desde && EntityFunctions.TruncateTime(c.Fecha) <= this.Hasta));
        ...
        public void Preparar(int iUsuarioID)
        {
            ...
            this.oMetaSucursal = General.GetEntity<MetaSucursal>(c => c.SucursalID == this.SucursalID);
            this.oMetaVendedor = General.GetEntity<MetaVendedor>(c => c.VendedorID == this.UsuarioID);
        }
    ...
    class MetasAnimaciones
    {
        ...
        public class ComisionActualMarca
        {
            ...
            public void CargarDatos(PictureBox pcbMarca)
            {
                ...
                this.mAcumulado = Helper.ConvertirDoble(this.lblBarraMarca.Text.SoloNumeric());
        ...
        public class Tacometro
        {
            ...
            public void CargarDatos(PictureBox pcbTacometro)
            {
                ...
                decimal mAnguloFinal = Helper.ConvertirDecimal(this.pcbTacometroMarca.Tag);
                ...
                decimal mUtilidad = Helper.ConvertirDecimal(this.lblUtilidadTotal.Text.SoloNumeric());
            ...
            public bool EjecutarPaso()
            {
                ...
                {  // Animación inicial, de principio a fin
                    ...
                    this.pcbTacometroMarca.Image = Helper.RotateImage(this.oFlecha, iPaso);
                }
                else
                {  // Animación final, de fin a valor correspondiente
                    ...
                    {  // Se completó la animación final
                        this.pcbTacometroMarca.Image = Helper.RotateImage(this.oFlecha, (float)this.mAnguloFinal);
