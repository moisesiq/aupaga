...
namespace Refaccionaria.App
{
    public partial class CajaDetalle : UserControl
    {
        ...
        private void dgvDetalle_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                this.FilaVistoBuenoCambiado(this.dgvDetalle.CurrentRow, Helper.ConvertirBool(this.dgvDetalle.CurrentRow.Cells["VistoBueno"].Value));
            }
        }
        ...
        private void dgvDetalle_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.ShiftKey)
            {
                ...
                this.dgvDetalle.CurrentRow.Cells["VistoBueno"].Value = !Helper.ConvertirBool(this.dgvDetalle.CurrentRow.Cells["VistoBueno"].Value);
            }
        }
        ...
        protected virtual string VentaFormasDePago(int iVentaID)
        {
            ...
            var oPagos = General.GetListOf<VentasPagosDetalleView>(q => q.VentaID == iVentaID);
