...
namespace Refaccionaria.App
{
    public partial class CajaCorte : UserControl
    {
        ...
        private void dgvDetalle_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (Helper.ConvertirCadena(this.dgvDetalle.CurrentRow.Cells["Contenido"].Value).Trim().ToLower() == "hay en caja")
            {
        ...
        public void ActualizarDatos()
        {
            ...
            // 
            var Corte = General.ExecuteProcedure<pauCajaCorte_Result>("pauCajaCorte", oParams);
            ...
            var oCambios = General.ExecuteProcedure<cdcCambios>("pauCajaDetalleCorte", oParams);
            // Se agrega el título
