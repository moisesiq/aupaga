...
namespace Refaccionaria.App
{
    public partial class CobroTarjeta : Form
    {
        ...
        private void CobroTarjeta_Load(object sender, EventArgs e)
        {
            ...
            this.cmbCuenta.CargarDatos("BancoCuentaID", "NombreDeCuenta", General.GetListOf<BancoCuenta>(
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            this.BancoCuentaID = Helper.ConvertirEntero(this.cmbCuenta.SelectedValue);
