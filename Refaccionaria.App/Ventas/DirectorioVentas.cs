...
namespace Refaccionaria.App
{
    public partial class DirectorioVentas : UserControl
    {
        ...
        private void listLinea_DrawItem(object sender, DrawListViewItemEventArgs e)
        {
            ...
            Refaccionaria.Negocio.Controles.ControlPicture.DibujarSombraLista(this.ImagenesLineas, e);
        }
        ...
        private void listMarca_DrawItem(object sender, DrawListViewItemEventArgs e)
        {
            ...
            Refaccionaria.Negocio.Controles.ControlPicture.DibujarSombraLista(this.ImagenesMarca, e);
        }
        ...
        {
            return Helper.ConvertirEntero(Elemento.SubItems[1].Text);
        }
        ...
        internal int BuscaProveedorConIdParte(int IdParte = 0, bool TraeParte = false)
        {
            ...
            var oParte = General.GetEntity<Parte>(p => p.ParteID == IdParte);
        ...
        private void cargaProveedorUnicoOPorParte(int IdProveedor)
        {
            ...
            var Pro = General.GetEntity<ProveedorContactoPrincipalView>(p => p.ProveedorID == IdProveedor);
            ...
            if (this.IdPartSelect > 0)
            {
                ...
                var PartesEq = General.GetListOf<ProveedorEquivalContactoPpalView>(q => q.ParteIDEquivalente == this.IdPartSelect);
        ...
        private void cargaProveedorPorLineaMarca(string PorLineaMarca)
        {
            ...
            {
                var oProveeLinea = General.GetListOf<ProveedorLineaView>(p => p.LineaID == this.IdLinea).ToList();
                foreach (var ProLin in oProveeLinea)
                {
                    var Pro = General.GetEntity<ProveedorContactoPrincipalView>(p => p.ProveedorID == ProLin.ProveedorID);
                    string Imagen = Pro.ProveedorID.ToString();
                    string Direccion = Pro.Direccion + ", " + Pro.Ciudad + ", C.P. " + Pro.CP + ", " + Pro.Estado;
            ...
            {
                var oProveeLinea = General.GetListOf<ProveedorMarcaParteView>(p => p.MarcaParteID == this.IdMarca).Distinct().ToList();
                foreach (var ProLin in oProveeLinea)
                {
                    var Pro = General.GetEntity<ProveedorContactoPrincipalView>(p => p.ProveedorID == ProLin.ProveedorID);
                    string Imagen = Pro.ProveedorID.ToString();
        ...
        internal void cargaProveedorPorFiltro(string Filtro)
        {
            if (this.TotalDeProvee != listProvee.Items.Count || this.TotalDeProvee == 0 || Filtro != "" || this.ItemsPorPagina == listProvee.Items.Count)
            {
                ...
                if (this.ContadorPaginas == 0)
                {
                    ...
                    {
                        oProveedor = General.GetListOf<ProveedorContactoPrincipalView>(p => p.NombreProveedor.Contains(Filtro)).ToList();
                ...
                if (tjContactos.Visible == true)
                {
                    ...
                    oProveedor = General.GetListOf<ProveedorContactoPrincipalView>(p => p.NombreProveedor.Contains(Filtro)).Skip(Inicia).Take(this.ItemsPorPagina).ToList();
        ...
        private void cargaLineaPorParte(int IdParte)
        {
            ...
            Parte oParte = General.GetEntity<Parte>(p => p.ParteID == IdParte);
            var oLinea = General.GetListOf<LineasView>(l => l.LineaID == oParte.LineaID).ToList();
        ...
        private void cargaLineaPorProveedorMarca(string PorProveedorMarca)
        {
            ...
            {
                var oLinea = General.GetListOf<ProveedorLineaView>(l => l.ProveedorID == this.IdProveedorLinea).ToList();
                foreach (var item in oLinea)
                    this.listLinea.Items.Add(CargaLineas(item.LineaID.ToString(), item.NombreLinea));
            }
            ...
            {
                var oLinea = General.GetListOf<LineaMarcaPartesView>(l => l.MarcaParteID == this.IdMarca).ToList();
                foreach (var item in oLinea)
                    this.listLinea.Items.Add(CargaLineas(item.LineaID  .ToString(), item.NombreLinea));
            }
        }
        ...
        private void cargaLineaPorFiltro(string Filtro)
        {
            if (this.TotalDeLineas != listProvee.Items.Count || this.TotalDeLineas == 0 || Filtro != "")
            {
                ...
                var oLineas = General.GetListOf<LineasView>(p => p.NombreLinea.Contains(Filtro)).ToList();
        ...
        private void cargaMarcaPorParte(int IdParte)
        {
            ...
            Parte oParte = General.GetEntity<Parte>(p => p.ParteID == IdParte);
            var oMarcas = General.GetListOf<MarcaPartesView>(l => l.MarcaParteID == oParte.MarcaParteID).ToList();
        ...
        private void cargaMarcaPorProveedorLinea(string PorProveedorLinea)
        {
            ...
            {
                var oMarca = General.GetListOf<ProveedorMarcaParteView>(l => l.ProveedorID == this.IdProveedorMarca).Distinct().ToList();
            ...
            {
                var oMarca = General.GetListOf<LineaMarcaPartesView>(l => l.LineaID == this.IdLinea).ToList();
                foreach (var item in oMarca)
                    this.listMarca.Items.Add(CargaMarcas(item.MarcaParteID.ToString(), item.NombreMarcaParte));
            }
        }
        ...
        private void cargaMarcaPorFiltro(string Filtro)
        {
            if (this.TotalDeMarcas != listProvee.Items.Count || this.TotalDeMarcas == 0 || Filtro != "")
            {
                ...
                var oMarcas = General.GetListOf<MarcaPartesView>(p => p.NombreMarcaParte.Contains(Filtro)).ToList();
                foreach (var Mar in oMarcas)
                    this.listMarca.Items.Add(CargaMarcas(Mar.MarcaParteID.ToString(), Mar.NombreMarcaParte));
        ...
        private void CargaProveedores(string IdProveedor, string Proveedor, string Nombre, string IdContacto, string TelUno, string TelDos, string TelTres, string Direccion, string PaginaWeb, bool generico = false)
        {
            ...
            sLlaveImg = Refaccionaria.Negocio.Controles.ControlPicture.ImagenEnLista(this.ImagenesProvee, sLlaveImg, "(" + sLlaveImg + ").jpg", sRutaImagen);
        ...
        private ListViewItem CargaLineas(string LineaId, string NombreLinea)
        {
            ...
            sLlaveImg = Refaccionaria.Negocio.Controles.ControlPicture.ImagenEnLista(this.ImagenesLineas, sLlaveImg, "(" + sLlaveImg + ").jpg", sRutaImagen);
        ...
        private ListViewItem CargaMarcas(string MarcaId, string NombreMarca)
        {
            ...
            sLlaveImg = Refaccionaria.Negocio.Controles.ControlPicture.ImagenEnLista(this.ImagenesMarca, sLlaveImg, "(" + sLlaveImg + ").jpg", sRutaImagen);
