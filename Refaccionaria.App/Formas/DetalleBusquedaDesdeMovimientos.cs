    ...
    public partial class DetalleBusquedaDesdeMovimientos : DetalleBase
    {
        ...
        private void txtCodigo_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                var lst = Negocio.General.ExecuteProcedure<pauPartesBusquedaEnMovimientos_Result>("pauPartesBusquedaEnMovimientos", dic);
                ...
                if (lst != null)
                {
                    ...
                    Helper.OcultarColumnas(this.dgvDatos, new string[] { "ParteID" });
