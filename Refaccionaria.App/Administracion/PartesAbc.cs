...
namespace Refaccionaria.App
{
    public partial class PartesAbc : UserControl
    {
        ...
        {
            if (Helper.ConvertirBool(this.Tag))
            {
        ...
        private void MostrarDatos()
        {
            ...
            this.oPartesAbc = General.ExecuteProcedure<pauPartesAbc_Result>("pauPartesAbc", oParams);
        ...
        private void ProcesarDatos()
        {
            ...
            var oRangos = General.GetListOf<ParteAbcRango>();
        ...
        private void GuardarDatos()
        {
            ...
            for (int iFila = this.IndiceGuardado; iFila < iFilas; iFila++)
            {
                ...
                iParteID = Helper.ConvertirEntero(Fila.Cells["ParteID"].Value);
                oParte = General.GetEntity<ParteAbc>(q => q.ParteID == iParteID);
                ...
                Guardar.Generico<ParteAbc>(oParte);
