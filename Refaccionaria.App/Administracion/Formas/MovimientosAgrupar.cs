    ...
    public partial class MovimientosAgrupar : Form
    {
        ...
        private void MovimientoAgrupar_Load(object sender, EventArgs e)
        {
            ...
            if (this.bEsNuevo)
            {
                ...
                {
                    var oReg = General.GetEntity<MovimientoInventario>(c => c.MovimientoInventarioID == iMovID && c.Estatus);
            ...
            else
            {
                ...
                // Se llenan los datos
                var oMovAgr = General.GetEntity<MovimientoInventario>(c => c.MovimientoInventarioID == this.iMovimientoAgrupadorID && c.Estatus);
                iProveedorID = oMovAgr.ProveedorID.Valor();
                var oMovs = General.GetListOf<MovimientoInventario>(c => c.MovimientoAgrupadorID == this.iMovimientoAgrupadorID && c.Estatus);
