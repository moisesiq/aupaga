                ...
                */
                case "tabPageMovimientos":
                    ...
                    if (this.panelMovimientos.Controls.Count <= 0)
                    {
                        ...
                        if (!UtilDatos.ValidarPermiso("Administracion.Movimientos.Ver", true))
                            return;
                        //
                ...
                case "tabPartes":
                    // Se valida el permiso correspondiente
                    if (!UtilDatos.ValidarPermiso("Administracion.CatalogosPartes.Ver", true))
                        return;
                    //
                ...
                case "tabProveedores":
                    // Se valida el permiso correspondiente
                    if (!UtilDatos.ValidarPermiso("Administracion.Proveedores.Ver", true))
                        return;
                    //
                ...
                case "tabTraspasos":
                    ...
                    {
                        // Se valida el permiso correspondiente
                        if (!UtilDatos.ValidarPermiso("Administracion.Traspasos.Ver", true))
                            return;
                        //
                ...
                case "tabMxMn": // Máximos y mínimos
                    ...
                    */
                    ...
                    {
                        // Se valida el permiso correspondiente
                        if (!UtilDatos.ValidarPermiso("Administracion.MaximosyMinimos.Ver", true))
                            return;
                        //
                ...
                case "tabPedidos":
                    ...
                    {
                        // Se valida el permiso correspondiente
                        if (!UtilDatos.ValidarPermiso("Administracion.Pedidos.Ver", true))
                            return;
                        //
                ...
                case "tabClientes":
                    ...
                    {
                        // Se valida el permiso correspondiente
                        if (!UtilDatos.ValidarPermiso("Administracion.Clientes.Ver", true))
                            return;
                        //
                ...
                case "tbpMaster":
                    ...
                    {
                        // Se valida el permiso correspondiente
                        if (!UtilDatos.ValidarPermiso("Administracion.Master.Ver", true))
                            return;
                        //
                ...
                case "tbpInventario":
                    ...
                    {
                        // Se valida el permiso correspondiente
                        if (!UtilDatos.ValidarPermiso("Administracion.Inventario.Ver", true))
                            return;
                        //
                ...
                case "tbpCriteriosABC":
                    ...
                    {
                        // Se valida el permiso correspondiente
                        if (!UtilDatos.ValidarPermiso("Administracion.CriteriosAbc.Ver", true))
                            return;
                        //
                ...
                case "tbpAplicaciones":
                    ...
                    {
                        // Se valida el permiso correspondiente
                        if (!UtilDatos.ValidarPermiso("Administracion.Aplicaciones.Ver", true))
                            return;
                        //
                ...
                case "tbpCapitalHumano":
                    ...
                    {
                        // Se valida el permiso correspondiente
                        if (!UtilDatos.ValidarPermiso("Administracion.CapitalHumano.Ver", true))
                            return;
                        //
