...
namespace Refaccionaria.App
{
    public partial class CambiosSistema : UserControl
    {
        ...
        private void btnModificar_Click(object sender, System.EventArgs e)
        {
            ...
            int iCambioSistemaID = Helper.ConvertirEntero(this.dgvDatos.CurrentRow.Cells["CambioSistemaID"].Value);
        ...
        private void ActualizarDatos()
        {
            ...
            var oDatos = General.GetListOf<CambioSistema>();
            this.Lista.DataSource = Helper.ListaEntityADataTable<CambioSistema>(oDatos);
