    ...
    public class CodigoDinamico
    {
        ...
        public object GenerarInstancia()
        {
            ...
            if (oCompilado.Errors.HasErrors)
            {
                ...
                Helper.MensajeError(sMensaje, "Errores de compilación");
                return null;
            }
            ...
            if (oClase == null)
            {
                Helper.MensajeError("No se pudo cargar la clase con el código especificado", "Error");
                return null;
            }
        ...
        public static object EjecutarMetodo(object oObjeto, string sMetodo, params object[] aParametros)
        {
            ...
            {
                Helper.MensajeError(string.Format("Error en el método {0}\n\nError: {1}{2}", sMetodo, e.Message, 
