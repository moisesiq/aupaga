...
namespace Refaccionaria.Negocio
{
    public partial class TextoAutocompletar : UserControl
    {
        ...
        private void txtBusqueda_TextChanged(object sender, EventArgs e)
        {
            ...
            this.oFuenteFiltro.Filter = Helper.ObtenerCadenaDeFiltro(this.dgvDatos, this.txtBusqueda.Text);
        ...
        private void MostrarSeleccion(DataGridViewRow oFila)
        {
            ...
            {
                this.txtBusqueda.Text = Helper.ConvertirCadena(oFila.Cells[this.CampoMostrar].Value);
                this.txtBusqueda.SelectAll();
            }
        }
