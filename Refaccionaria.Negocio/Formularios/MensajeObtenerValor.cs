        ...
        public MensajeObtenerValor(string sMensaje, object oValorPredeterminado, Tipo TipoDeValor)
        {
            ...
            switch (this.TipoDeValor)
            {
                ...
                case Tipo.TextoLargo:
                    this.txtValor.Text = Helper.ConvertirCadena(oValorPredeterminado);
                ...
                case Tipo.Entero:
                    ...
                    this.nudValor.Value = Helper.ConvertirEntero(oValorPredeterminado);
                ...
                case Tipo.Decimal:
                    ...
                    this.nudValor.Maximum = 9999999;
                    this.nudValor.Value = Helper.ConvertirDecimal(oValorPredeterminado);
                    this.AgregarControl(this.nudValor);
                    break;
                case Tipo.Fecha:
                    this.dtpValor = new DateTimePicker();
                    this.dtpValor.Format = DateTimePickerFormat.Short;
                    this.dtpValor.Value = Helper.ConvertirFechaHora(oValorPredeterminado);
